...
public class CreateTaskBottomSheetFragmentStudent extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, TodoFragment
                           fragment) {
        this.taskId = taskId;
        this.isEdit = isEdit;
    ...
    public boolean validateFields() {
        if(addTaskTitle.getText().toString().equalsIgnoreCase("")) {
            ...
            Toast.makeText(fragment.getActivity(), "Please enter a valid description", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if (taskDate.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(fragment.getActivity(), "Please enter date", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if (taskTime.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(fragment.getActivity(), "Please enter time", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(taskEvent.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(fragment.getActivity(), "Please enter an event", Toast.LENGTH_SHORT).show();
            return false;
        }
        else {
            return true;
