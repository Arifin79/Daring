...
public class TaskAdapterStudent extends RecyclerView.Adapter<TaskAdapterStudent.TaskViewHolder> {
    ...
    CreateTaskBottomSheetFragmentStudent.setRefreshListener setRefreshListener;

    public TaskAdapterStudent(TodoFragment context, List<Task> taskList, CreateTaskBottomSheetFragmentStudent.setRefreshListener setRefreshListener) {
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.menuUpdate:
                    ...
                    createTaskBottomSheetFragmentStudent.setTaskId(task.getTaskId(), true,  fragment, fragment);
                    createTaskBottomSheetFragmentStudent.show(fragment.getActivity().getSupportFragmentManager(), createTaskBottomSheetFragmentStudent.getTag());
                    break;
