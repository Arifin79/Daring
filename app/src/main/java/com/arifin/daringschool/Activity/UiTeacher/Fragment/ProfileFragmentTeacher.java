...
import com.arifin.daringschool.Activity.UiTeacher.Activity.EditProfileTeacherActivity;
...
public class ProfileFragmentTeacher extends Fragment {
    ...
    @BindView(R.id.img_profile_account_teacher)
    CircleImageView imgAccount;
    @BindView(R.id.tv_profile_account_teacher)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnEditProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(getActivity(), EditProfileTeacherActivity.class);
                getActivity().startActivity(intent);
            }
        });
