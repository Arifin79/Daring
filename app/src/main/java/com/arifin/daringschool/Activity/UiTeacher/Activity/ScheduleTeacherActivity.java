...
import com.arifin.daringschool.Activity.UiTeacher.Adapter.ScheduleAdapter;
...
public class ScheduleTeacherActivity extends AppCompatActivity {
    ...
    private ScheduleAdapter assigmentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assigmentAdapter = new ScheduleAdapter( ScheduleTeacherActivity.this, assignmentList);
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(ScheduleTeacherActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
