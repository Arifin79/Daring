...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(TodoFragment context, List<Task> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.menuUpdate:
                    ...
                    createTaskBottomSheetFragment.setTaskId(task.getTaskId(), true,  fragment, fragment);
                    createTaskBottomSheetFragment.show(fragment.getActivity().getSupportFragmentManager(), createTaskBottomSheetFragment.getTag());
                    break;
