package com.arifin.daringschool.CalendarBottomSheetFragment;
...
public class ShowCalenderViewBottomSheet extends BottomSheetDialogFragment {
    Unbinder unbinder;
    ...
    public void setupDialog(@NonNull @NotNull Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.bottom_sheet_calender_view, null);
        unbinder = ButterKnife.bind(this, contentView);
        dialog.setContentView(contentView);
        calendarView.setHeaderColor(R.color.md_blue_600);
        getSavedTasks();
